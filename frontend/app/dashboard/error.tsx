...
export default function DashboardError({
  ...
  return (
    <main className="beep-brand bg-background text-foreground mx-auto flex min-h-svh w-full max-w-3xl flex-col items-center justify-center px-4 text-center">
      ...
      <p className="text-muted-foreground mt-2 max-w-md text-[13px] font-normal">
      ...
      {error.message && (
        <p className="border-border text-muted-foreground mt-4 max-w-md border px-3 py-2 text-left font-mono text-[12px] break-words">
          {error.message}
        </p>
      )}
