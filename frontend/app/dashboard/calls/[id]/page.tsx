...
export default async function CallPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!lead) {
    return (
      <main className="mx-auto flex min-h-svh w-full max-w-3xl flex-col items-center justify-center px-4 text-center">
  ...
  return <LiveCallView lead={lead} roomName={lead.room_name ?? null} isDemo={isDemo} />;
}
